...
mod overlap_position {
    ...
    fn empty_empty() {
        assert_eq!(
            EmptiableAbsBoundPair::Empty.overlap_position(&EmptiableAbsBoundPair::Empty),
    ...
    fn empty_unbounded() {
        assert_eq!(
            EmptiableAbsBoundPair::Empty.overlap_position(&AbsBoundPair::new(
    ...
    fn unbounded_empty() {
        assert_eq!(
            AbsBoundPair::new(AbsStartBound::InfinitePast, AbsEndBound::InfiniteFuture)
                .overlap_position(&EmptiableAbsBoundPair::Empty),
            Ok(OverlapPosition::Outside),
        );
    }
    ...
    fn half_bounded_equal() -> Result<(), Box<dyn Error>> {
        assert_eq!(
            ...
            .overlap_position(&HalfBoundedAbsInterval::new_from_time(
                "2025-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp(),
                OpeningDirection::ToFuture
            )),
    ...
    fn half_bounded_exclusive_inclusive() -> Result<(), Box<dyn Error>> {
        assert_eq!(
            ...
            .overlap_position(&HalfBoundedAbsInterval::new_from_time_and_inclusivity(
                "2025-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp(),
                BoundInclusivity::Inclusive,
                OpeningDirection::ToFuture,
            )),
    ...
    fn bounded_equal_various_bound_inclusivities() -> Result<(), Box<dyn Error>> {
        assert_eq!(
            ...
            .overlap_position(&BoundedAbsInterval::from_times_incl(
                "2025-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp(),
                BoundInclusivity::Inclusive,
                "2025-01-02 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp(),
                BoundInclusivity::Exclusive,
