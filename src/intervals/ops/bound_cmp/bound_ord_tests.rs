...
fn abs_start_start_less_inf_past_finite() -> Result<(), Box<dyn Error>> {
    assert_eq!(
        AbsoluteStartBound::InfinitePast.bound_partial_cmp(
...
fn abs_start_start_equal_inf_past() {
    assert_eq!(
        AbsoluteStartBound::InfinitePast.bound_partial_cmp(&AbsoluteStartBound::InfinitePast),
...
fn abs_start_start_greater_finite_inf_past() -> Result<(), Box<dyn Error>> {
    assert_eq!(
        AbsoluteFiniteBoundPosition::new("2025-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())
            .to_start_bound()
            .bound_partial_cmp(&AbsoluteStartBound::InfinitePast),
...
fn abs_start_end_less_inf_past_inf_future() {
    assert_eq!(
        AbsoluteStartBound::InfinitePast.bound_partial_cmp(&AbsoluteEndBound::InfiniteFuture),
        BoundOrdering::Less,
    );
}
...
fn abs_start_end_less_finite_inf_future() -> Result<(), Box<dyn Error>> {
    assert_eq!(
        AbsoluteFiniteBoundPosition::new("2025-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())
            .to_start_bound()
            .bound_partial_cmp(&AbsoluteEndBound::InfiniteFuture),
        BoundOrdering::Less,
    );
...
fn abs_end_start_greater_inf_future_inf_past() {
    assert_eq!(
        AbsoluteEndBound::InfiniteFuture.bound_partial_cmp(&AbsoluteStartBound::InfinitePast),
        BoundOrdering::Greater,
    );
}
...
fn abs_end_start_greater_inf_future_finite() -> Result<(), Box<dyn Error>> {
    assert_eq!(
        AbsoluteEndBound::InfiniteFuture.bound_partial_cmp(
            &AbsoluteFiniteBoundPosition::new("2025-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())
                .to_start_bound()
        ),
        BoundOrdering::Greater,
...
fn abs_end_end_equal_inf_future_inf_future() {
    assert_eq!(
        AbsoluteEndBound::InfiniteFuture.bound_partial_cmp(&AbsoluteEndBound::InfiniteFuture),
        BoundOrdering::Equal(None),
    );
}
...
fn rel_start_start_less_inf_past_finite() {
    assert_eq!(
        RelativeStartBound::InfinitePast
            .bound_partial_cmp(&RelativeFiniteBoundPosition::new(SignedDuration::from_hours(101)).to_start_bound()),
        BoundOrdering::Less,
    );
}
...
fn rel_start_start_less_finite_finite() {
    assert_eq!(
        RelativeFiniteBoundPosition::new(SignedDuration::from_hours(101))
            .to_start_bound()
            .bound_partial_cmp(&RelativeFiniteBoundPosition::new(SignedDuration::from_hours(102)).to_start_bound()),
        BoundOrdering::Less,
    );
}
...
fn rel_start_start_equal_inf_past() {
    assert_eq!(
        RelativeStartBound::InfinitePast.bound_partial_cmp(&RelativeStartBound::InfinitePast),
        BoundOrdering::Equal(None),
    );
}
...
fn rel_start_start_greater_finite_inf_past() {
    assert_eq!(
        RelativeFiniteBoundPosition::new(SignedDuration::from_hours(101))
            .to_start_bound()
            .bound_partial_cmp(&RelativeStartBound::InfinitePast),
        BoundOrdering::Greater,
    );
}
...
fn rel_start_end_less_inf_past_inf_future() {
    assert_eq!(
        RelativeStartBound::InfinitePast.bound_partial_cmp(&RelativeEndBound::InfiniteFuture),
        BoundOrdering::Less,
    );
}
...
fn rel_start_end_less_inf_past_finite() {
    assert_eq!(
        RelativeStartBound::InfinitePast
            .bound_partial_cmp(&RelativeFiniteBoundPosition::new(SignedDuration::from_hours(101)).to_end_bound()),
        BoundOrdering::Less,
    );
}
...
fn rel_start_end_less_finite_inf_future() {
    assert_eq!(
        RelativeFiniteBoundPosition::new(SignedDuration::from_hours(101))
            .to_start_bound()
            .bound_partial_cmp(&RelativeEndBound::InfiniteFuture),
        BoundOrdering::Less,
    );
}
...
fn rel_start_end_less_finite_finite() {
    assert_eq!(
        RelativeFiniteBoundPosition::new(SignedDuration::from_hours(101))
            .to_start_bound()
            .bound_partial_cmp(&RelativeFiniteBoundPosition::new(SignedDuration::from_hours(102)).to_end_bound()),
        BoundOrdering::Less,
    );
}
...
fn rel_end_start_greater_inf_future_inf_past() {
    assert_eq!(
        RelativeEndBound::InfiniteFuture.bound_partial_cmp(&RelativeStartBound::InfinitePast),
        BoundOrdering::Greater,
    );
}
...
fn rel_end_end_equal_inf_future_inf_future() {
    assert_eq!(
        RelativeEndBound::InfiniteFuture.bound_partial_cmp(&RelativeEndBound::InfiniteFuture),
        BoundOrdering::Equal(None),
    );
}
