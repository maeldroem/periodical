...
fn abs_start_start_less_inf_past_finite() -> Result<(), Box<dyn Error>> {
    assert_eq!(
        AbsStartBound::InfinitePast
            .bound_cmp(&AbsFiniteBoundPos::new("2025-01-01 00:00:00Z".parse::<Timestamp>()?).to_start_bound()),
        BoundOrdering::Less,
    );
...
fn abs_start_start_less_finite_finite() -> Result<(), Box<dyn Error>> {
    assert_eq!(
        AbsFiniteBoundPos::new("2025-01-01 00:00:00Z".parse::<Timestamp>()?)
            .to_start_bound()
            .bound_cmp(&AbsFiniteBoundPos::new("2025-01-02 00:00:00Z".parse::<Timestamp>()?).to_start_bound()),
        BoundOrdering::Less,
    );
...
fn abs_start_end_less_inf_past_finite() -> Result<(), Box<dyn Error>> {
    assert_eq!(
        AbsStartBound::InfinitePast
            .bound_cmp(&AbsFiniteBoundPos::new("2025-01-01 00:00:00Z".parse::<Timestamp>()?).to_end_bound()),
        BoundOrdering::Less,
    );
...
fn abs_start_end_less_finite_finite() -> Result<(), Box<dyn Error>> {
    assert_eq!(
        AbsFiniteBoundPos::new("2025-01-01 00:00:00Z".parse::<Timestamp>()?)
            .to_start_bound()
            .bound_cmp(&AbsFiniteBoundPos::new("2025-01-02 00:00:00Z".parse::<Timestamp>()?).to_end_bound()),
        BoundOrdering::Less,
    );
...
fn rel_start_end_less_inf_past_finite() {
    assert_eq!(
        RelStartBound::InfinitePast.bound_cmp(&RelFiniteBoundPos::new(SignedDuration::from_hours(101)).to_end_bound()),
        BoundOrdering::Less,
    );
}
