...
fn since_week() -> Result<(), Box<dyn Error>> {
    ...
    assert_eq!(interval.reference(), "2026-01-26 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp());
...
fn since_month() -> Result<(), Box<dyn Error>> {
    ...
    assert_eq!(since_month.reference(), "2026-03-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp());
...
fn until_month() -> Result<(), Box<dyn Error>> {
    ...
    assert_eq!(until_month.reference(), "2026-03-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp());
...
fn since_year() -> Result<(), Box<dyn Error>> {
    ...
    assert_eq!(since_year.reference(), "2026-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp());
...
fn until_year() -> Result<(), Box<dyn Error>> {
    ...
    assert_eq!(until_year.reference(), "2026-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp());
