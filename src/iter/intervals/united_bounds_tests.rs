...
mod abs_united_bounds {
    ...
    fn create() -> Result<(), Box<dyn Error>> {
        let data = [
            ...
            AbsoluteBoundPair::new(
                AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-06 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
                AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-10 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
            ),
            AbsoluteBoundPair::new(
                AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2024-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
    ...
    fn run() -> Result<(), Box<dyn Error>> {
        let mut data = [
            ...
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2024-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-02 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-05 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-10 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-20 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-10 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-12 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-11 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-15 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-13 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-17 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-19 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-25 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            ...
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-30 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-02-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-02-05 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-02-04 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::InfiniteFuture),
            AbsoluteBound::Start(AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-05-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
            AbsoluteBound::End(AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-06-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp()))),
        ];
    ...
    fn run_from_abs_bounds_iter() -> Result<(), Box<dyn Error>> {
        let data = [
            AbsoluteBoundPair::new(
                ...
                AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2024-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
            ),
            AbsoluteBoundPair::new(
            ...
            AbsoluteBoundPair::new(
                AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-10 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
                AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-12 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
            ),
            AbsoluteBoundPair::new(
                AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-11 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
                AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-15 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
            ),
            AbsoluteBoundPair::new(
                AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-13 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
                AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-01-17 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
            ),
            AbsoluteBoundPair::new(
                AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-01-19 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
            ...
            AbsoluteBoundPair::new(
                AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-02-04 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
                AbsoluteEndBound::InfiniteFuture,
            ),
            AbsoluteBoundPair::new(
                AbsoluteStartBound::Finite(AbsoluteFiniteBound::new("2025-05-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
                AbsoluteEndBound::Finite(AbsoluteFiniteBound::new("2025-06-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())),
            ),
        ];
...
mod rel_united_bounds {
    ...
    fn run() {
        let mut data = [
            ...
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(1)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(
                12,
            )))),
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(15)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(
                20,
            )))),
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(30)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(
                20,
            )))),
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(22)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(
                21,
            )))),
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(25)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(
                23,
            )))),
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(27)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(
                29,
            )))),
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(35)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new_with_inclusivity(
                SignedDuration::from_hours(35),
                BoundInclusivity::Exclusive,
            ))),
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(40)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(
                50,
            )))),
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(55)))),
            RelativeBound::Start(RelativeStartBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(
                54,
            )))),
            ...
            RelativeBound::End(RelativeEndBound::Finite(RelativeFiniteBound::new(SignedDuration::from_hours(201)))),
        ];
