...
mod rel {
    ...
    fn run() {
        ...
        let second_layer_data = [
            ...
            // 4
            RelBoundPair::new(
                RelFiniteBoundPos::new_with_inclusivity(SignedDuration::from_hours(120), BoundInclusivity::Exclusive)
                    .to_start_bound(),
                RelFiniteBoundPos::new_with_inclusivity(SignedDuration::from_hours(130), BoundInclusivity::Exclusive)
                    .to_end_bound(),
            ),
            // 7
            RelBoundPair::new(
                RelFiniteBoundPos::new_with_inclusivity(SignedDuration::from_hours(201), BoundInclusivity::Exclusive)
                    .to_start_bound(),
                RelFiniteBoundPos::new_with_inclusivity(SignedDuration::from_hours(205), BoundInclusivity::Exclusive)
                    .to_end_bound(),
            ),
            // 8
            RelBoundPair::new(
