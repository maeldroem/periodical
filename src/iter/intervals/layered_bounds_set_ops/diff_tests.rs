...
mod abs {
    ...
    fn create() -> Result<(), Box<dyn Error>> {
        ...
        let _ = LayeredAbsBoundsDifference::new(data.into_iter());
    ...
    fn run() -> Result<(), Box<dyn Error>> {
        ...
        let first_layer_data = [
            ...
            // 8
            AbsBoundPair::new(
                AbsFiniteBoundPos::new("2025-02-17 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())
                    .to_start_bound(),
                AbsFiniteBoundPos::new("2025-02-23 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())
                    .to_end_bound(),
            ),
        ];
        ...
        let second_layer_data = [
            ...
            AbsBoundPair::new(
                AbsFiniteBoundPos::new("2025-01-01 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())
                    .to_start_bound(),
                AbsFiniteBoundPos::new("2025-01-07 00:00:00[Europe/Oslo]".parse::<Zoned>()?.timestamp())
                    .to_end_bound(),
            ),
            // 3
            AbsBoundPair::new(
...
mod rel {
    ...
    fn create() {
        ...
        let _ = LayeredRelBoundsDifference::new(data.into_iter());
    }
    ...
    fn run() {
        ...
        let first_layer_data = [
            ...
            RelBoundPair::new(
                ...
                RelFiniteBoundPos::new(SignedDuration::from_hours(215)).to_end_bound(),
            ),
            // 8
            RelBoundPair::new(
                RelFiniteBoundPos::new(SignedDuration::from_hours(217)).to_start_bound(),
                RelFiniteBoundPos::new(SignedDuration::from_hours(223)).to_end_bound(),
            ),
        ];
        ...
        let second_layer_data = [
            ...
            RelBoundPair::new(
                ...
                RelFiniteBoundPos::new(SignedDuration::from_hours(107)).to_end_bound(),
            ),
            // 3
            RelBoundPair::new(
